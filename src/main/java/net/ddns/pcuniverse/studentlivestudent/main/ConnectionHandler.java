...
public class ConnectionHandler {
    ...
    public static String LOCAL_ADDRESS = "127.0.0.1"; //TODO
    public static final String INTERNET_ADDRESS = "pcuniverse.ddns.net";
    ...
    public volatile ObservableList<AssignmentDetails> assignments = FXCollections.observableArrayList();
    ...
    private void connect() {
        if (!connectLocal()) {
            if (!connectInternet()) {
                UserNotification.showErrorMessage("Connection Error", "Failed to connect to StudentLive Servers! (" + LOCAL_ADDRESS + ")\nPlease check your network connection and try again!");
