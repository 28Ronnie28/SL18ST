...
public class TimetableBlock extends HBox{
    ...
    private Color[] accentColour = {Color.rgb(155, 0, 0), Color.rgb(255, 184, 28), Color.rgb(0, 0, 153), Color.rgb(51, 153, 51), Color.rgb(18, 178, 166), Color.rgb(158, 00, 126), Color.rgb(234, 06, 126), Color.rgb(132, 189, 00), Color.rgb(234, 06, 126)};
